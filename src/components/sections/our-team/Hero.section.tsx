...
const OurTeamHero: React.FC = () => {
  return (
    <section className="relative h-2/3 flex justify-center items-center">
      ...
      <div className="z-10 flex flex-col gap-5 text-white w-full max-w-5xl px-6 sm:px-10 md:pl-12">
        <h1 className="text-5xl sm:text-7xl uppercase animatecss animatecss-bounce">
          Meet our Team
        </h1>
        <p className="text-sm sm:text-xl max-w-2xl pl-2">
